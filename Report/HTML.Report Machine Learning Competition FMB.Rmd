...
One of the first things we wanted to check is that our training-set was representative enought of the testing data. For that we checked that the training and sample set where equally distributed for all variables. After checking the means and quantiles of the data we saw that the distributions where very similar betweeen the two data sets. That should ensure that the model in the training set performs as good as the testing set. To show visualy the results the following boxplot shows the similarity of elevation of the two data sets. Also a density plot of the splope shows that the two data sets are equally distributed, and therefore our training set is representative of all the data.
